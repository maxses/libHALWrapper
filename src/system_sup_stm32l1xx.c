/**---------------------------------------------------------------------------
 *
 * @file       system_sup_stm32l1xx.c
 * @brief      Default system clock config for STM32L1 devices
 *
 * Check stm32l1xx_hal_rcc.c from HAL for OSC values.
 *
 * @date       20240821
 ...
 */
__attribute__ ((weak))
void SystemClock_Config_l1(void)
{
