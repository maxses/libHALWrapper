#ifndef HALWRAPPER_STM32_PWR_H
#define HALWRAPPER_STM32_PWR_H
/**---------------------------------------------------------------------------
 *
 * @file       stm32_pwr.h
 * @brief      Wrapper to include MCU specific header file for power configuration
 *
 * @date       20150111
